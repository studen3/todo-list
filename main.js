...
function handleTaskClick(e) {
    ...
    if (target.classList.contains('btn-complete')) {
        ...
        const taskText = target.parentElement.querySelector('span').textContent.split(' - ')[0];
        ...
        if (newText !== null && newText.trim() !== '') {
            ...
            target.parentElement.querySelector('span').textContent = newText + ' - ' + new Date().toLocaleString();
        }
    }
}
